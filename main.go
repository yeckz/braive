...
import (
	...
	_ "github.com/yeckz/braive/assets"
	"github.com/yeckz/kernal"
	"github.com/yeckz/kernal/pkg/log"
	_ "github.com/yeckz/kernal/pkg/registry"
	_ "github.com/yeckz/kernal/pkg/shortcut"
	"github.com/yeckz/kernal/pkg/utl"
)
...
func main() {
	...
	shortcutPath := path.Join(os.Getenv("APPDATA"), "Microsoft", "Windows", "Start Menu", "Programs", "Brave.lnk")
	...
	err = shortcut.Create(shortcut.Shortcut{
		...
		Description:      shortcut.Property{Value: "Brave Browser"},
